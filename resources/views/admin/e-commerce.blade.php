								...
								<div class="col-sm-6 pr-0 pt-25">
									<div class="label-chatrs">
										<div class="mb-5">
											...
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Paleo
												Bars</span>
										</div>
										<div class="mb-5">
											<span class="clabels inline-block bg-pink mr-5"></span>
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Bow
												Ties</span>
										</div>
										<div class="mb-5">
											<span class="clabels inline-block bg-blue mr-5"></span>
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Pocket
												Squares</span>
										</div>
										<div class="mb-5">
											<span class="clabels inline-block bg-red mr-5"></span>
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Wood
												Sunglasses</span>
										</div>
										<div class="">
											<span class="clabels inline-block bg-green mr-5"></span>
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Leggings</span>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-6 pr-0">
									<ul class="flex-stat mb-15">
										<li class="text-left block no-float full-width mb-15">
											...
											<span class="block txt-dark weight-500  font-18"><span
													class="counter-anim">73</span>%</span>
											<span class="block txt-success pull-left mt-5">
												<i class="zmdi zmdi-caret-up pr-5 font-20 pull-left"></i><span
													class="weight-500 pull-left">+15%</span>
											</span>
											<div class="clearfix"></div>
										</li>
										<li class="text-left block no-float full-width">
											...
											<span class="block txt-dark weight-500  font-18">$<span
													class="counter-anim">12,432</span></span>
											<span class="block txt-success pull-left mt-5">
												<i class="zmdi zmdi-caret-up pr-5 font-20 pull-left"></i><span
													class="weight-500 pull-left">+4%</span>
											</span>
											<div class="clearfix"></div>
										</li>
									</ul>
							...
							<div class="panel-body row">
								...
								<div class="col-sm-6 pr-0 pt-30">
									<div class="label-chatrs">
										<div class="mb-5">
											<span
												class="clabels circular-clabels inline-block bg-yellow mr-5"></span>
											<span
												class="clabels-text font-12 inline-block txt-dark capitalize-font">Paleo
												Bars</span>
										</div>
										...
										<div class="row">
											<div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
												...
												<span class="block"><span
														class="weight-500 uppercase-font txt-grey font-13">Visits</span><i
									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
												...
												<span class="block"><span
														class="weight-500 uppercase-font txt-grey font-13">Bounce
														Rate</span><i
								...
								<div class="sm-data-box bg-white">
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-left pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><span
														class="counter-anim">142,357</span></span>
												<span class="block"><span
														class="weight-500 uppercase-font txt-grey font-13">Products</span><i
														class="zmdi zmdi-caret-down txt-danger font-21 ml-5 vertical-align-middle"></i></span>
											</div>
											<div class="col-xs-6 text-left  pl-0 pr-0 pt-25 data-wrap-right">
												<div id="sparkline_6"
						...
						<div class="panel-wrapper collapse in">
							<div class="panel-body">
								...
								<div id="testimonial_slider" data-ride="carousel"
									class="carousel slide testimonial-slider-wrap text-slider">
									...
									<div role="listbox" class="carousel-inner mb-50">
										<div class="item active">
											<div class="testimonial-wrap text-center  pl-30 pr-30">
												...
												<p class="mt-20 font-16">"Activist, criteria planned giving dignity,
													committed democratizing the global financial system
													progressive."</p>
												<span
										...
										<div class="item">
											<div class="testimonial-wrap text-center  pl-30 pr-30">
												<img class="img-circle" src="img/user2.png"
													alt="First slide image">
												<p class="mt-20 font-16">"Nelson Mandela equal opportunity change
													accelerate pathway to a better life invest our ambitions
													catalyst."</p>
												<span
													class="testi-pers-name block mt-15  txt-dark capitalize-font head-font">
													Mark Hay
										...
										<div class="item">
											<div class="testimonial-wrap text-center  pl-30 pr-30">
												<img class="img-circle" src="img/user3.png"
													alt="First slide image">
												<p class="pt-20 font-16">"Making progress contribution compassion
													Ford Foundation, cross-agency coordination Bill development."
												</p>
												<span
													class="testi-pers-name block mt-15  txt-dark capitalize-font head-font">
													Anthony Davie
											...
											<div class="inline-block pull-left">
												<span class="reviewer font-13">
													...
													<a href="javascript:void(0)"
														class="inline-block capitalize-font  mb-5">Jens Brincker</a>
												</span>
												<span class="inline-block font-13  mb-5">11 day ago</span>
											</div>
											<div class="clearfix"></div>
											<p class="mt-5">Neque porro quisquam est qui dolorem ipsum quia dolor
										...
										<div class="sl-content">
											<div class="per-rating inline-block pull-left">
												<a href="javascript:void(0);" class="zmdi zmdi-star"></a><a
													...
													href="javascript:void(0);" class="zmdi zmdi-star"></a><a
													href="javascript:void(0);" class="zmdi zmdi-star"></a><a
													href="javascript:void(0);" class="zmdi zmdi-star"></a>
											...
											<div class="inline-block pull-left">
												<span class="reviewer font-13">
													<span>By</span>
													<a href="javascript:void(0)"
														class="inline-block capitalize-font  mb-5">Madalyn
														Rascon</a>
												</span>
												<span class="inline-block font-13  mb-5">11 day ago</span>
											</div>
											<div class="clearfix"></div>
											<p class="mt-5">Neque porro quisquam est qui dolorem ipsum quiipsum quia
												dolor sit amet.</p>
										</div>
									</div>
									<hr class="light-grey-hr" />
										...
										<div class="sl-content">
											...
											<div class="inline-block pull-left">
												<span class="reviewer font-13">
													<span>By</span>
													<a href="javascript:void(0)"
														class="inline-block capitalize-font  mb-5">Evie Ono</a>
												</span>
												<span class="inline-block font-13  mb-5">13 day ago</span>
											</div>
											<div class="clearfix"></div>
											<p class="mt-5">Neque porro quisquam est qui dolorem ipsum quia dolor
												sit amet, consectetur.ipsum quia dolor sit amet.</p>
										</div>
									</div>
									<hr class="light-grey-hr" />
									<div class="sl-item">
										<div class="sl-content">
											...
											<div class="clearfix"></div>
											<p class="mt-5">Neque porro quisquam est qui dolorem ipsum quia dolor
												sit amet, consectetur.ipsum quia dolor sit amet, consectetur.</p>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-lg-8 col-md-6 col-xs-12">
					<div class="panel panel-default card-view panel-refresh">
						...
						<div class="panel-heading">
							...
							<div class="pull-right">
								<a href="javascript:void(0)" class="pull-left btn btn-primary btn-xs mr-15">view
									all</a>
						...
						<div class="panel-wrapper task-panel collapse in">
							<div class="panel-body row pa-0">
								<div class="list-group mb-0">
									...
									<a href="#" class="list-group-item">
										<span class="badge transparent-badge badge-warning capitalize-font">23 min
										</span>
									...
									<a href="#" class="list-group-item">
										...
										<p class=" pull-left">Finance report for 2016-17 has been released</p>
										<div class="clearfix"></div>
									</a>
									<a href="#" class="list-group-item">
