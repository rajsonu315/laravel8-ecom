									...
									<div class="table-wrap">
										<div class="table-responsive">
											...
											<div class="form-actions pull-right pr-15">
												<button class="btn btn-success btn-anim mr-10 pull-left"><i
														class="fa fa-shopping-cart"></i><span
														class="btn-text">continue shopping</span></button>
												<button class="btn btn-primary btn-anim pull-left"><i
														class="fa fa-sign-out"></i><span
														class="btn-text">checkout</span></button>
