                                        ...
                                        <table class="table display responsive product-overview mb-30" id="myTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('admincom/img/chair.jpg')}}" alt="iMac" width="80">
                                                    </td>
                                                    <td>Square Chair</td>
                                                    <td>20</td>
                                                    <td>10-10-2016</td>
                                                    ...
                                                    <td><a href="javascript:void(0)" class="text-inverse pr-10"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('admincom/img/chair2.jp')}}g" alt="iPhone" width="80">
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('admincom/img/chair3.jp')}}g" alt="apple_watch" width="80">
                                                    </td>
                                                    <td>Rounded Chair</td>
                                                    <td>10</td>
                                                    <td>08-10-2016</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{url('admincom/img/chair4.jp')}}g" alt="mac_mouse" width="80">
                                                    </td>
                                                    <td>Wooden chair</td>
                                                    <td>15</td>
                                                    <td>02-10-2016</td>
