                   ...
                   <div class="row">
                       <div class="col-12 col-md-6 col-lg-12">
                           <div class="footer_logo">
                               <img loading="lazy" src="{{ asset('assets/images/svg/logo.svg') }}" alt="easy shop">
                           </div>
   ...
   <div class="copyright_wrap">
       <div class="container">
           <div class="row align-items-center">
               <div class="col-md-6">
                   <p class="copyright_text">©  All Rights Reserved</p>
               </div>
               <div class="col-md-6">
                   <div class="payment_method">
                       <img loading="lazy" src="{{ asset('assets/images/payment-method.png') }}" alt="payment method">
                   </div>
               </div>
           </div>
       </div>
