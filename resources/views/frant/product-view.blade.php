...
@section('content')
    ...
    <div class="container">
        <div class="breadcrumbs">
            ...
            <a href="#">Shop</a>
            <a href="#" class="active">Men's Adidas Courtsmash</a>
        </div>
    </div>
                ...
                <div class="col-lg-6">
                    <div class="product_info_wrapper">
                        ...
                        <div class="product_buttons">
                            <a href="{{ route('shopping_cart') }}" class="default_btn small rounded me-sm-3 me-2 px-4"><i
                                    class="icon-cart me-2"></i> Add to Cart</a>
                            <a href="{{ route('wish_list') }}" class="default_btn small rounded second border-none"><i
                                    class="icon-heart me-2"></i> Wishlist</a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_new_arrive">
                        ...
                        <div class="sna_content">
                            ...
                            <a href="{{ route('admin.product_cart') }}" class="href">
                                <div class="product_adcart">
                                    <button class="default_btn">Add to cart</button>
                                </div>
                            </a>
